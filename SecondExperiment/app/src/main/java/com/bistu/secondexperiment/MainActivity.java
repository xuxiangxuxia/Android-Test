...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_user = findViewById(R.id.button_2);
        button_user.setOnClickListener(this);
        EditText user = findViewById(R.id.edit_6);
    ...
    public void login() {
        //登录界面的实现,先新建一个sharepreference对象，用来存储用户信息
        SharedPreferences.Editor editor = getSharedPreferences("user", MODE_PRIVATE).edit();
        SharedPreferences editor_1 = this.getSharedPreferences("user", MODE_PRIVATE);
        Random random = new Random();
        EditText user = (EditText) findViewById(R.id.edit_6);
        EditText password = (EditText) findViewById(R.id.edit_5);
        //获取密码的值
